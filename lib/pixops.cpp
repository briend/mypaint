  ...
  for (int y=0; y<MYPAINT_TILE_SIZE/2; y++) {
    ...
    for(int x=0; x<MYPAINT_TILE_SIZE / 2; x++) {
      for (int chan=0; chan < MYPAINT_NUM_CHANS - 2; chan++) {
        ...
        dst_p[MYPAINT_NUM_CHANS - 2] = ((src_p[MYPAINT_NUM_CHANS - 2] * 0.5 + (src_p + MYPAINT_NUM_CHANS)[MYPAINT_NUM_CHANS - 2] * 0.5 + (src_p + MYPAINT_NUM_CHANS * MYPAINT_TILE_SIZE)[MYPAINT_NUM_CHANS - 2] * 0.5 + (src_p + MYPAINT_NUM_CHANS * MYPAINT_TILE_SIZE + MYPAINT_NUM_CHANS)[MYPAINT_NUM_CHANS - 2] * 0.5)) / 4.0;
